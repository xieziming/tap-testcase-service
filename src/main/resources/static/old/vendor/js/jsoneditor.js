...
JSONEditor.AbstractEditor = Class.extend({
  ...
  setupWatchListeners: function() {
    ...
    if(this.schema.hasOwnProperty('watch')) {
      ...
      for(var name in this.schema.watch) {
        ...
        if(!root) throw "Could not find ancestor node with uid "+first;
  ...
  getDisplayText: function(arr) {
    ...
    // Determine how many times each attribute operation is used.
...
JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
  ...
  build: function() {
    ...
    // If the object should be rendered as a div
      ...
      this.addproperty_input.setAttribute('placeholder','Property operation...');
      ...
      this.addproperty_add.addEventListener('click',function(e) {
        ...
        if(self.addproperty_input.value) {
          if(self.editors[self.addproperty_input.value]) {
            window.alert('there is already a property with that operation');
            return;
          }
...
JSONEditor.defaults.languages.en = {
   ...
   * @variables This key takes one variable: The operation of the missing property
   */
  error_required: "Object is missing the required property '{{0}}'",
  /**
   * When there is an additional property is set whereas there should be none
   * @variables This key takes one variable: The operation of the additional property
   */
  error_additional_properties: "No additional properties allowed, but property {{0}} is set",
  /**
   * When a dependency is not resolved
   * @variables This key takes one variable: The operation of the missing property for the dependency
   */
